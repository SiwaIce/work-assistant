...
function rStock(el) {
  ...
  if (stockCategoryFilter !== 'all') rows = rows.filter(function(r) { return r.product.category === stockCategoryFilter; });
  ...
  if (!rows.length) {
    ...
    rows.forEach(function(r) {
      ...
      h += '<td style="text-align:center;font-weight:700">' + r.qty + '</td>';
