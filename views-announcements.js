...
function showAnnModal(annId) {
  ...
  h += '<textarea id="annContent" class="inp" rows="5" placeholder="เนื้อหาประกาศ..." style="width:100%;box-sizing:border-box;resize:vertical;margin-top:3px">' + sanitize(ann ? ann.content || '' : '') + '</textarea></div>';
